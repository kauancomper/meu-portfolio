export interface RepoMeta {
  pt: { highlight: string; detail: string };
  en: { highlight: string; detail: string };
  es: { highlight: string; detail: string };
  image?: string;
  url?: string;
  tools?: string[];
  screenshots?: string[];
...
export const REPO_DESCRIPTIONS: Record<string, RepoMeta> = {
  'meu-portfolio': {
    pt: {
    ...
    tools: ['React', 'TypeScript', 'Vite', 'Framer Motion', 'Tailwind CSS', 'Three.js'],
    screenshots: []
  },
  'portfolio_kc': {
    pt: {
  ...
  'portfolio_jn_redesign': {
    ...
    tools: ['React', 'TypeScript', 'Playwright', 'Docker', 'Node.js'],
    screenshots: []
  },
  ...
  'BDII-TGI': {
    ...
    tools: ['FastAPI', 'Python', 'PostgreSQL', 'Docker', 'SQLAlchemy'],
    screenshots: []
  },
  'tg1bdi': {
    pt: {
